...
// {
//     var rabbitMQ = new RabbitMQService("localhost");
//     rabbitMQ.DeclareQueue("order-created");
//     rabbitMQ.DeclareQueue("inventory-updated");
//     return rabbitMQ;
// });
...
// rabbitMQService.ConsumeMessages<InventoryUpdatedEvent>("inventory-updated", (evt) =>
// {
...
// app.MapPost("/orders", async (Order order, OrderContext context, IHttpClientFactory httpClientFactory, HttpContext httpContext, RabbitMQService rabbitMQ) =>
// {
...
//     rabbitMQ.PublishMessage("order-created", orderCreatedEvent);
